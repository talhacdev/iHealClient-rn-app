      ...
      <>
        <ScrollView
          ...
          {/* <View style={{ paddingLeft: 20 }} >
                    ...
                    >
                        <Text style={styles.headerText} >Add Credit/ Debit Card</Text>
                        <Icon name="plus" style={{ color: colors.primary, fontSize: 30 }} />
                    </TouchableOpacity> */}
          <View style={{marginBottom: DEVICE_HEIGHT > 600 ? 20 : 30}}>
            {/* <TouchableOpacity
                            // onPress={() => this.handler('2')}
                            style={[styles.paymentMethod, { marginTop: 30, }]}
                        >
                            <Text style={styles.headerText} >Pay At My Location</Text>
                        </TouchableOpacity> */}
            <TouchableOpacity
              style={[
              ...
              onPress={() =>
                Alert.alert('iHeal', 'This feature is coming soon')
              }>
              <Text
                style={[
                  styles.headerText,
